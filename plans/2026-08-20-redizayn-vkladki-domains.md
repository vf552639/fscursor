...
- **Реализован целиком: да** — все шесть фаз закрыты 2026-08-20/21, ветка
  `feat/domains-redesign`. Сюита выросла с 1481/121 до 1517/124, `tsc` чист,
...
6. **Кнопки одного ряда на разных языках** — «Проверить на сервере» и
   `Provision`/`Provisioning…` в правом слоте `SnapshotLine`. Раньше английское
   слово жило в `title` иконки и в глаза не бросалось.
