 ...
 *
 * Один цвет на оба, хотя раньше подписи красились посветлее (`#d97706`, тот же
 * жёлтый, что у `Badge.yellow`): на белом при кегле 11–12.5px он даёт контраст
 * около 3.2:1 — ниже AA, то есть пометка «· stale» читалась хуже, чем цифра, о
 * которой она предупреждает. У `#a16207` — около 4.8:1.
 */
