 ...
 *
 * Цвет — приглушённый тёплый серый (`stone-400`): протухшее должно уходить на
 * второй план, а не бросаться в глаза собственным оттенком. Плата за это —
 * контраст на белом около 2.5:1, ниже AA. Компромисс осознанный: опознаётся
 * протухшее не по цвету, а по подписи «· stale» рядом с ним, цвет лишь приглушает.
 */
export const STALE_TEXT = "#a8a29e";
