 ...
 * оттенок. AA для мелкого текста этот цвет всё равно не держит, поэтому
 * подпись «· stale» рядом — не украшение, а второй, дублирующий канал
 * распознавания, а не единственный.
 */
