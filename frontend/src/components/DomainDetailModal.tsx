 ...
 * пароли (почему — у `onProvision` в `DomainServerTab`). Это не отмена
 * правила, а его выполнение.
 *
...
export default function DomainDetailModal({
   ...
   *
   * Транзит намеренный: кнопка принадлежит вкладке, запуск — странице.
   * Почему — у `onProvision` в `DomainServerTab`, там канон.
   */
  onProvision: () => void;
