  ...
  return (
    <button
      ...
      style={{
        ...
        // Семейство шрифта не назначается — как в `Btn` и `ui/Tabs`, и по той
        // же причине: у `<button>` шрифт не наследуется, но `index.css`
        // (`input,select,textarea,button`) уже переводит все формы на общее
        // семейство. Прежний хардкод `'Inter'` держал имя шрифта, никогда в
        // приложение не попадавшего, и после перехода на IBM Plex Sans выбивал
        // бы чип из строки вместо того, чтобы его в ней удерживать.
        fontSize: 13,
