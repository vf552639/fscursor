 ...
 * показывает там `SSL: Valid · until 24.04.2041`. Они живут в карточке SSL
 * (`DomainSslCard`) на вкладке Overview, где рядом стоит возраст снимка, из
 * которого прочитаны. Довод от переезда не ослаб, а усилился: карточка эта
 * открыта по умолчанию, то есть копия стояла бы не «где-то на другой вкладке»,
 * а двумя рядами выше на ТОМ ЖЕ экране — ровно тот дубль, ради снятия которого
 * карточка пересобрана в августе 2026 (автор макета об этом знать не мог).
 * Шапке хватает состояния.
 *
