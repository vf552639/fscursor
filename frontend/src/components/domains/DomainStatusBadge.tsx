 ...
 *
 * `title` пропсом остаётся и ПЕРЕБИВАЕТ подсказку, но сегодня его никто не
 * передаёт, и это не забывчивость. Перебивал его один вызывающий — строка
 * списка, — и класть туда текст провалившегося прогона стоило погашенного
 * объяснения ступени ровно до тех пор, пока сам текст был обрезан до одного
 * слова в колонке шириной 110 пикселей: подсказка бейджа была единственным
 * местом, где он читался целиком. Колонка ушла, текст переехал под имя домена,
 * виден там двумя строками и несёт СВОЙ полный `title` — то есть пересказ в
 * подсказке бейджа стал третьей копией одной строки, купленной ценой
 * единственного объяснения того, чем «Failed» отличается от «Site created».
 * Размен перестал сходиться, и перебивание снято.
 */
