 ...
 *
 * Из `ui/Primitives` они по-прежнему видны реэкспортом — чтобы существующие
 * импорты остались рабочими и переезд читался как переезд, а не как правка
 * пригоршни чужих файлов. Новому коду правильнее звать этот модуль напрямую.
 *
