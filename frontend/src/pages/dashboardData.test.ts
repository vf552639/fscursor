...
describe("auditRowToActivity", () => {
  ...
  it("has exactly one label per SAFE_ACTIONS entry (bump to 39 -> N when backend/app/audit/service.py::SAFE_ACTIONS changes)", () => {
    expect(Object.keys(ACTION_LABELS).length).toBe(39);
  });
