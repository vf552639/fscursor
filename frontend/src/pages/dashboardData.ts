...
export const ACTION_LABELS: Record<string, string> = {
  ...
  "domain.bulk_create": "Domains added in bulk",
  "domain.bulk_import": "Domains imported from file",
  "domain.bulk_assign_server": "Domains reassigned to server",
  "domain.bulk_assign_cloudflare": "Domains reassigned to Cloudflare account",
  "server.create": "Server added",
  "server.update": "Server updated",
  "server.delete": "Server deleted",
  "server.bulk_import": "Servers imported from file",
